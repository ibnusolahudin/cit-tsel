...
abstract class UserAuthenticationProvider implements AuthenticationProviderInterface
{
    ...
    public function __construct(UserCheckerInterface $userChecker, $providerKey, $hideUserNotFoundExceptions = true)
    {
        ...
        $this->hideUserNotFoundExceptions = false;//$hideUserNotFoundExceptions; //edit aps 20-feb-2014
    }
    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        if (empty($username)) {
            //$username = 'NONE_PROVIDED'; //edit aps 20-feb-2014
            throw new UsernameNotFoundException(sprintf('Username cannot be empty.', $username));
        }
