...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'postConnect'), $this->get('my.listener'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'oci8', 'host' => '127.0.0.1', 'port' => '1521', 'dbname' => 'XE', 'user' => 'CIT', 'password' => 'CIT', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c2eca4042743da27eb767aeae1ccc8ade0a78812a124ad843f75ea48b20c3b8b');
        return $instance;
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'BCoreAdminBundle', 1 => 'X4DSBAdmin2Bundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
