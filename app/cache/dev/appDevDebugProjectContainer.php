...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'agn.menu.voter.request' => 'getAgn_Menu_Voter_RequestService',
            ...
            'security.firewall.map.context.auth_login' => 'getSecurity_Firewall_Map_Context_AuthLoginService',
    ...
    /**
     * Gets the 'agn.menu.voter.request' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \App\AgnBundle\Menu\RequestVoter A App\AgnBundle\Menu\RequestVoter instance.
     */
    protected function getAgn_Menu_Voter_RequestService()
    {
        return $this->services['agn.menu.voter.request'] = new \App\AgnBundle\Menu\RequestVoter($this);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BCoreAdminBundle', ($this->targetDirs[2].'/Resources/BCoreAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BCoreAdminBundle', ($this->targetDirs[3].'\\src\\Template\\bcore\\adminbundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'X4DSBAdmin2Bundle', ($this->targetDirs[2].'/Resources/X4DSBAdmin2Bundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'X4DSBAdmin2Bundle', ($this->targetDirs[3].'\\src\\Template\\x4d\\sbadmin2bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postConnect'), $this->get('my.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'oci8', 'host' => '127.0.0.1', 'port' => '1521', 'dbname' => 'XE', 'user' => 'CIT', 'password' => 'CIT', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\App\\AgnBundle\\Entity'))), 'App\\AgnBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AppAgnBundle' => 'App\\AgnBundle\\Entity'));
    ...
    protected function getKnpMenu_MatcherService()
    {
        ...
        $instance->addVoter($this->get('agn.menu.voter.request'));
        $instance->addVoter($this->get('knp_menu.voter.router'));
    ...
    {
        return $this->services['my.listener'] = new \Doctrine\DBAL\Event\Listeners\OracleSessionInit();
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('App\\AgnBundle\\Entity\\AgnUsers' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.auth_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/apps/auth/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/apps'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.auth_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_AuthLoginService()
    {
        return $this->services['security.firewall.map.context.auth_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/apps');
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '_auth_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '_auth_logout'));
        ...
        $k->setOptions(array('login_path' => '_auth_login', 'default_target_path' => '_agn_homepage', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('login_path' => '_auth_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.administrators')), 'secured_area', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $k, $l, array('check_path' => '_auth_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, '_auth_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('secured_area', '_auth_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'BCoreAdminBundle', 1 => 'X4DSBAdmin2Bundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\App\\AgnBundle/Resources/views'), 'AppAgn');
        $instance->addPath(($this->targetDirs[3].'\\src\\Template\\x4d\\sbadmin2bundle/Resources/views'), 'X4DSBAdmin2');
        $instance->addPath(($this->targetDirs[3].'\\src\\Template\\bcore\\adminbundle/Resources/views'), 'BCoreAdmin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1b286cab8307d3ff04c58cd93fec5fdcf0fb07e5');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.administrators'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppAgnBundle:AgnUsers', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AppAgnBundle' => 'App\\AgnBundle\\AppAgnBundle',
                'X4DSBAdmin2Bundle' => 'Template\\x4d\\sbadmin2bundle\\X4DSBAdmin2Bundle',
                'BCoreAdminBundle' => 'Template\\bcore\\adminbundle\\BCoreAdminBundle',
            ...
            'locale' => 'en',
            'secret' => '1b286cab8307d3ff04c58cd93fec5fdcf0fb07e5',
            ...
            'kernel.secret' => '1b286cab8307d3ff04c58cd93fec5fdcf0fb07e5',
